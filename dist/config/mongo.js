...
exports.buildMongoUrl = buildMongoUrl;
/**
 ...
 */
function buildMongoUrl(env = process.env) {
    ...
    if (rest.split("/")[0].includes("@")) {
        throw new Error("MONGODB_URL must not contain credentials when MONGODB_USERNAME and MONGODB_PASSWORD are set");
    }
